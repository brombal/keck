import { AnyConstructor } from 'keck/util/types';
import { FactoryObservableContext } from 'keck/core/ObservableContext';
...
declare function reset(observable: any, focus?: boolean): void;
